...
<body>
    ...
    <script>
        async function loadData() {
            try {
                const response = await fetch('https://lmytguwz6dqsnvgucnz6jzzegq0cbppf.lambda-url.ap-southeast-2.on.aws/');
                const data = await response.json();

                // Cập nhật thống kê (giữ nguyên như cũ)
                ...
                // Cập nhật danh sách công ty với thông tin mới
